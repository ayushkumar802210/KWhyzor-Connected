...
function render(page){const titles={dashboard:"Dashboard",detective:"Bill Detective",simulator:"What-If Simulator",twin:"Electricity Twin",scanner:"Bill Scanner",bills:"Bills",appliances:"Appliances",ev:"EV Analysis",solar:"Solar Planner",reports:"Reports",alerts:"Alerts",settings:"Settings"};$("#pageTitle").textContent=titles[page]||"Dashboard";$$(".nav-item[data-page]").forEach(b=>b.classList.toggle("active",b.dataset.page===page));const pages={dashboard,detective,simulator,twin,scanner,bills,appliances,ev,solar,reports,alerts,settings};$("#pageContent").innerHTML=(pages[page]||dashboard)()}
